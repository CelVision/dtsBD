...
$mixinfo = array
	( 
	array('class' => 'h', 'stuff' => array('杂炊','松茸'),'result' => array('松茸御饭','HS',120,2,),'karma1'=>'-233','karma2'=>'1048576',),
	...
	array('class' => 'h', 'stuff' => array('面包','矿泉水','锅？'),'result' => array('☆法式长棍面包☆','HB',100,2,),),
	...
	array('class' => 'h', 'stuff' => array('曾经的荣光-橙黄','面包'),'result' => array('更改菜谱后的不甜酱包','HB',300,3,'Z'),),
	...
	array('class' => 'wk', 'stuff' => array('毒针','毒针'),'result' => array('D.毒针','WK',64,20,'pp'),),
	array('class' => 'wk', 'stuff' => array('D.毒针','D.毒针','D.毒针'),'result' => array('D.D.D','WK',192,80,'pppN'),),
	array('class' => 'wk', 'stuff' => array('白色的羽毛','白色的羽毛','白色的羽毛','白色的羽毛','白色的羽毛'),'result' => array('纯白片翼','WK',150,200,'iiiii'),),
	...
	array('class' => 'wk', 'stuff' => array('『祝福宝石』','『风魔激光刃』'),'result' => array('Azurewrath','WK',50,9999,'rci'),),
	array('class' => 'wk', 'stuff' => array('绿色方块','绿色方块'),'result' => array('沾满绿锈的铜刀','WK',52,52,'p'),),
	array('class' => 'wk', 'stuff' => array('沾满绿锈的铜刀','『祝福宝石』'),'result' => array('妖刀【飞叶】','WK',52,52,'rp'),),
	array('class' => 'wk', 'stuff' => array('妖刀【飞叶】','★全地图唯一的野生高伤阔剑地雷★'),'result' => array('影刀【秋岚】','WK',522,522,'Zrpd'),),
	array('class' => 'wk', 'stuff' => array('冰封的『Oathkeeper』','火把'),'result' => array('『Oathkeeper』','WK',300,20,'u'),),
	array('class' => 'wk', 'stuff' => array('冰封的『Oathkeeper』','解冻药水'),'result' => array('『Oathkeeper』','WK',300,20,'u'),),
	array('class' => 'wk', 'stuff' => array('冰封的『Oblivion』','火把'),'result' => array('『Oblivion』','WK',120,20,'i'),),
	array('class' => 'wk', 'stuff' => array('冰封的『Oblivion』','解冻药水'),'result' => array('『Oblivion』','WK',120,20,'i'),),
	array('class' => 'wk', 'stuff' => array('『Oathkeeper』','『Oblivion』'),'result' => array('『Two Become One』','WK',240,50,'ui'),),
	...
	array('class' => 'wg', 'stuff' => array('火把','某种电子零件'),'result' => array('『红石电路』','X',1,1,''),),
	...
	array('class' => 'wd', 'stuff' => array('☆自爆电池☆','电磁IED','脉冲防线'),'result' => array('脉冲蓄电池','WD',240,60,'ed'),),
	array('class' => 'wd', 'stuff' => array('☆自爆电池☆','辐射IED','『破坏之杖』'),'result' => array('辐射蓄电池','WD',278,100,'pd'),),
	...
	array('class' => 'wd', 'stuff' => array('咖啡酒','百利甜','伏特加'),'result' => array('奇怪的三色饮料','HB',133,3),),
	...
	array('class' => 'item', 'stuff' => array('高压线圈','某种机械设备'),'result' => array('电磁发射装置','X',1,1,''),),
	...
	array('class' => 'pokemon', 'stuff' => array('白色的羽毛','银色方块'),'re=/sult' => array('露琪亚之羽','WK',50,200,'i'),),
	...
	array('class' => 'key', 'stuff' => array('■秋刀鱼罐头■','■银白口哨■','银白盒子'),'result' => array('群青多面体','Z',1,1,'Z'),),
	array('class' => 'key', 'stuff' => array('■彩色玻璃珠■','■奇怪的袋子■','银白盒子'),'result' => array('群青多面体','Z',1,1,'Z'),),
	array('class' => 'key', 'stuff' => array('■机械花束■','■巨大灯泡■','银白盒子'),'result' => array('群青多面体','Z',1,1,'Z'),),
	array('class' => 'key', 'stuff' => array('■速溶咖啡■','Untainted Glory','银白盒子'),'result' => array('群青多面体','Z',1,1,'Z'),),
	...
	array('class' => 'wf', 'stuff' => array('西瓜','水果刀','磨刀石'),'result' => array('西瓜刀','WK',99,'∞','rci'),),
	...
	array('class' => 'wf', 'stuff' => array('时符『Private Square』','幻之刃','永恒飞刃','银色方块'),'result' => array('『咲夜的世界』','WF',350,'∞','irc'),),
	array('class' => 'wf', 'stuff' => array('『咲夜的世界』','鲜红的生血','灵魂的结晶'),'result' => array('『收缩的世界』','WF',4500,'∞','irc'),),
  ...
  array('class' => 'ocg', 'stuff' => array('「电子龙」 ★5','「电子龙」 ★5','「电子龙」 ★5'),'result' => array('「电子终结龙」','WC10',256,'∞','Nnrc'),),
	...
	array('class' => 'hidden', 'stuff' => array('提示纸条D','提示纸条T','提示纸条S'),'result' => array('幻境控制密钥-空白','WC',1,1,'zd'),),
