...
$mixinfo = array
	...
	array('class' => 'wk', 'stuff' => array('毒针','毒针'),'result' => array('D.毒针','WK',64,40,'pp'),),
	array('class' => 'wk', 'stuff' => array('D.毒针','D.毒针','D.毒针'),'result' => array('D.D.D','WK',192,120,'pppN'),),
	array('class' => 'wk', 'stuff' => array('西瓜','水果刀','磨刀石'),'result' => array('西瓜刀','WK',99,'∞','Nnc'),),
	array('class' => 'wk', 'stuff' => array('白色的羽毛','白色的羽毛','白色的羽毛','白色的羽毛','白色的羽毛'),'result' => array('纯白片翼','WK',300,200,'ia'),),
	...
	array('class' => 'wk', 'stuff' => array('冰封的『Oblivion』','火把'),'result' => array('『Oblivion』','WK',120,10,'i'),),
	array('class' => 'wk', 'stuff' => array('冰封的『Oblivion』','解冻药水'),'result' => array('『Oblivion』','WK',120,10,'i'),),
	array('class' => 'wk', 'stuff' => array('『Oathkeeper』','『Oblivion』'),'result' => array('『Two Become One』','WK',240,20,'ui'),),
	...
	array('class' => 'wd', 'stuff' => array('★炸药★','水鸳鸯'),'result' => array('★C4★','WD',250,60,'dddy'),),
	...
	array('class' => 'wf', 'stuff' => array('空白符卡','★制御棒★','向日葵'),'result' => array('『地狱的人造太阳』','WF',522,'∞','udr'),),
	...
	array('class' => 'fseed', 'stuff' => array('◆生命数据','◆焰火'),'result' => array('◆◆◆生命数据','🎆O',50,1,),),
	array('class' => 'fseed', 'stuff' => array('◆意念数据','◆焰火'),'result' => array('◆◆◆意念数据','🎆D',250,1,),),
	
	array('class' => 'fseed', 'stuff' => array('◆焰火','◆焰火','◆火之碎片'),'result' => array('✦烈焰火','A',50,50,'x'),),
	...
	array('class' => 'fseed', 'stuff' => array('◆◆◆生命数据','✦烈焰火'),'result' => array('✦生命数据','🎆O',100,1,),),
	array('class' => 'fseed', 'stuff' => array('◆◆◆意念数据','✦烈焰火'),'result' => array('✦意念数据','🎆D',500,1,),),
	
	array('class' => 'fseed', 'stuff' => array('◆焰火','◆焰火','◆焰火','◆火之碎片','◆火之碎片'),'result' => array('★华焰火★','A',200,100,'xZ'),),
	...
	array('class' => 'fseed', 'stuff' => array('✦生命数据','★华焰火★'),'result' => array('★生命数据★','🎆O',250,1,),),
	...
	array('class' => 'fseed', 'stuff' => array('★生命数据★','☾真焰火☽'),'result' => array('☾生命数据☽','🎆O',500,1,),),
	array('class' => 'fseed', 'stuff' => array('★意念数据★','☾真焰火☽'),'result' => array('☾意念数据☽','🎆D',2000,1,),),
	
	array('class' => 'fseed', 'stuff' => array('◆篝火','◆篝火','◆篝火'),'result' => array('◆◆◆篝火','DB',50,1,'H'),),
	array('class' => 'fseed', 'stuff' => array('◆埋火','◆埋火','◆埋火'),'result' => array('◆◆◆埋火','DH',50,1,'A'),),
	array('class' => 'fseed', 'stuff' => array('◆永火','◆永火','◆永火'),'result' => array('◆◆◆永火','DF',50,1,'M'),),
	array('class' => 'fseed', 'stuff' => array('◆残火','◆残火','◆残火'),'result' => array('◆◆◆残火','DA',50,1,'a'),),

	array('class' => 'fseed', 'stuff' => array('◆◆◆篝火','✦烈焰火'),'result' => array('✦烈篝火','DB',50,5,'H'),),
	array('class' => 'fseed', 'stuff' => array('◆◆◆埋火','✦烈焰火'),'result' => array('✦烈埋火','DH',50,5,'A'),),
	array('class' => 'fseed', 'stuff' => array('◆◆◆永火','✦烈焰火'),'result' => array('✦烈永火','DF',50,5,'M'),),
	array('class' => 'fseed', 'stuff' => array('◆◆◆残火','✦烈焰火'),'result' => array('✦烈残火','DA',50,5,'a'),),

	array('class' => 'fseed', 'stuff' => array('✦烈篝火','✦烈篝火','✦烈篝火'),'result' => array('✦✦✦烈篝火','DB',200,50,'H'),),
	array('class' => 'fseed', 'stuff' => array('✦烈埋火','✦烈埋火','✦烈埋火'),'result' => array('✦✦✦烈埋火','DH',200,50,'A'),),
	array('class' => 'fseed', 'stuff' => array('✦烈永火','✦烈永火','✦烈永火'),'result' => array('✦✦✦烈永火','DF',200,50,'M'),),
	array('class' => 'fseed', 'stuff' => array('✦烈残火','✦烈残火','✦烈残火'),'result' => array('✦✦✦烈残火','DA',200,50,'a'),),
	...
	array('class' => 'fseed', 'stuff' => array('★华焰火★','◆火之碎片'),'result' => array('☾真焰火☽','A',500,500,'xZ'),),
	...
	array('class' => 'fseed', 'stuff' => array('☾真焰火☽','☾真焰火☽'),'result' => array('☼焰火☼','A',3000,3000,'xZ'),),
