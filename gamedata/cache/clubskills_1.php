...
(
	...
	(
		...
		因陷阱/战斗死亡时，转化所有的{$sktprp}并立刻复活，转化上线为1000点<br>
	...
	(
		...
		护盾值等于<span class='yellow'>(<span tooltip2='取决于你的报应点数'>[^rp^]</span>×[:sldr:]%)</span>的绝对值，最大1000点；<br>
	...
	(
		...
		每探索/移动<span class="yellow">[:mst:]</span>次，口袋中存量最低的元素数量和元素能量<span class="yellow">+[:minemsgain:]%</span><br>
	...
	(
		...
		'desc' => '清空你口袋中的所有元素并消耗一定量的元素能量，<br>
	...
	(
		'name' => '灵俑',
		'tags' => Array('passive'),
		'desc' => "发现尸体时，消耗等同于<span class=\"yellow\">尸体等级的平方根×提炼尸体可获得的元素数量和一定量的元素能量</span>，将尸体复活为{$sktpzombie}；<br>
	...
	(
		...
		火花持有者受到<span class="red">致命伤害</span>时，会消耗1000点元素能量紧急传送回避伤害，但<span class="red">永久失去</span>火花；<br>
		点击右侧的<span class="yellow">“切换”</span>键随时激活或禁用该技能<br>
		[^skill-active^]',
		'input' => '切换',
	...
	(
		'name' => '黑莲',
		'tags' => Array('active','limit'),
		'desc' => '本局已献祭<span class="redseed"> [^skillpara|c20_lotus-active_t^]</span>次<br>
		献祭黑莲花并消耗250点元素能量，口袋中所有元素存量<span class="yellow">x3</span><br>',
		'input' => '献祭',
		'no_reload_page' => 1,
