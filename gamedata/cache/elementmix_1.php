<?php
	...
	(
		...
		'琉璃血' => 'r_5-1',
		//分解武神之魂 获得随机配方_5 的第 0 条素材（与武神尸体相同，均为C.H.A.O.S的素材来源）
		'武神之魂' => 'r_5-0',
		/** 会吐道具的分解 **/
	...
	(
		...
		//0.电掣召唤仪：分解种火尸体随机获得：数量分别在5~60、60~70、70~80、80~90、90~100之间的5种不同元素
		0 => Array('stuff'=>Array(0=>'r50-60',1=>'r60-70',2=>'r70-80',3=>'r80-90',4=>'r90-100'),'result'=>Array('电掣召唤仪','Y',1,1,)),
