...
{
	global $log,$mapinfo,$hplsinfo,$arealist,$areanum,$hack,$exp;
...
{
	global $log,$weather,$mapinfo,$hplsinfo,$arealist,$areanum,$hack,$mapinfo,$gamestate,$gamecfg;
	global $actlog;
...
function pre_move_search_events(&$data,$act)
{
	...
	global $hpls_flag,$moveto,$hack,$areanum,$arealist,$mapinfo,$weather,$gamevars;
